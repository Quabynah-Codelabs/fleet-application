    ...
    <header class="header-global">
        <base-nav class="navbar-main" transparent type="" effect="light" expand>
            ...
            <!-- <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                <base-dropdown tag="li" class="nav-item">
                    <a slot="title" href="#" class="nav-link" data-toggle="dropdown" role="button">
                        ...
                        <span class="nav-link-inner--text">More options</span>
                    </a>
                    <router-link to="/dashboard" class="dropdown-item">Dashboard</router-link>
                    <router-link to="/upload" class="dropdown-item">Upload new item</router-link>
                </base-dropdown>
            </ul> -->
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                ...
                <li class="nav-item d-none d-lg-block ml-lg-4">
                    <a href="https://firebasestorage.googleapis.com/v0/b/fleet-mobile-app.appspot.com/o/app-debug.apk?alt=media&amp;token=f5a9b930-ed2f-40a0-8996-f112ff2a865f" rel="noopener"
