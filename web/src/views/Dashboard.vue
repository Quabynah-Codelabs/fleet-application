                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input id="input-sender" v-model="sender" class="form-control form-control-alternative" placeholder="Benjamin" type="text">
                            </div>
                        </div>
                        <div class="col-lg-4">
                        <div class="form-group">
...
export default {
    ...
    props: {
        ...
        email : {
            type: String,
            default: firebaseapp.auth.currentUser.email
        }
    },
    methods: {
        submitOrder: (ev) => {
